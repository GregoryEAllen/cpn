...
namespace CPN {
    ...
    public:
        ...
        bool Dequeue(T* data, CPN::ulong count) {
            return rqueue->RawDequeue((void*)data, sizeof(T) * count);
        }

        bool Dequeue(T* data, CPN::ulong count, CPN::ulong numChans, CPN::ulong chanStride) {
            return rqueue->RawDequeue((void*)data, sizeof(T) * count, numChans, sizeof(T) * chanStride);
        }
