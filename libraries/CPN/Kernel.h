...
namespace CPN {
    ...
    public:
        ...
        /** \brief Same as CreateNode that takes a NodeAttr except only the required parameters are set.
        ...
        /**
         * \return A pointer to the logger instance used by the kernel.
         */
         ...
         * TO BE CALLED ONLY BY THE CPN INTERNALS
         */
        ...
        /**
         * These values may be cached by queues and nodes.
         * Setting these values after any node or queue has been created
         * may give undeterministic behavior.
         * @{
         */
