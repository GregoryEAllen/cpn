...
Notice that we cannot call \verb|GetReader| or \verb|GetWriter| in the constructor because
...
The first thing the constructor does is to passes its parameters on to \verb!CPN::NodeBase! so that
...
The pseudo nodes were added for the explicit reason of having outside code that needed
