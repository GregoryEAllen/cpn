...
Provided in the CPN library are three implementations.
...
For example, it would be possible to implement a context that used a database and a synchronization service like ZooKeeper.
...
The parameters are given to the node as a string to string mapping and are available through the methods
