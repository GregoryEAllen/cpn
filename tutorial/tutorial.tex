...
If all of these fail then the database throws an exception indicating that no factory could be found
for that node type.
...
A \verb!run! script is provided in the code directory that runs the remote database daemon and then
